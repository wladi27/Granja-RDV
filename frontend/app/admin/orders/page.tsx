  ...
  return (
    <main className="mx-auto max-w-6xl px-4 pb-28 pt-4 md:px-6 md:pt-6">
      <section className="app-card p-5 sm:p-6">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-[var(--ink)] sm:text-3xl">Órdenes del carrito</h1>
        <p className="mt-2 text-sm text-[var(--muted)]">Visualiza y gestiona pedidos creados desde la tienda.</p>
      </section>
